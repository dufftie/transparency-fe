...
_To be respectful of the media outlets and avoid overloading their servers, we use a soft approach — requesting around one article per second._
...
The original prompt used for every analysis: 
```prompt
